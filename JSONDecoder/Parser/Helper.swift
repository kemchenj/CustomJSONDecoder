...
let space     = UTF8.CodeUnit(0x20)
let tab       = UTF8.CodeUnit(0x08)
let cr        = UTF8.CodeUnit(0x0D)
let newline   = UTF8.CodeUnit(0x0A)
let backspace = UTF8.CodeUnit(0x08)
let formfeed  = UTF8.CodeUnit(0x0C)
